...
class UIConstants {
  ...
  final double spacing1 = 4.0;
  final double spacing2 = 8.0;
  final double spacing3 = 12.0;
  final double spacing4 = 16.0;
  final double spacing5 = 20.0;
  final double spacing6 = 24.0;
  final double spacing7 = 28.0;
  final double spacing8 = 32.0;
  final double spacing10 = 40.0;
  final double spacing12 = 48.0;
  final double spacing16 = 64.0;
  final double spacing20 = 80.0;
  final double spacing24 = 96.0;
  final double _spacing36 = 144.0;
  ...
  final Color darkOnSecondaryFixed = Color(0xFF002110);
  ...
  // Blur Amounts
  final double glassBlurLight = 5.0;
  ...
  // White Glass Variants (For Light Theme & Highlights)
  final Color glassWhiteHigh = const Color(0xFFFFFFFF).withValues(alpha: 0.60);
  final Color glassWhiteMedium = const Color(
    0xFFFFFFFF,
  ).withValues(alpha: 0.40);
  final Color glassWhiteLow = const Color(0xFFFFFFFF).withValues(alpha: 0.20);
  final Color glassWhiteDim = const Color(0xFFFFFFFF).withValues(alpha: 0.10);
  final Color glassWhiteSeeThrough = const Color(
    0xFFFFFFFF,
  ).withValues(alpha: 0.05);

  // Black Glass Variants (For Dark Theme & Depth)
  final Color glassBlackHigh = const Color(0xFF000000).withValues(alpha: 0.60);
  final Color glassBlackMedium = const Color(
    0xFF000000,
  ).withValues(alpha: 0.40);
  final Color glassBlackLow = const Color(0xFF000000).withValues(alpha: 0.20);
  final Color glassBlackDim = const Color(0xFF000000).withValues(alpha: 0.10);
  final Color glassBlackSeeThrough = const Color(
    0xFF000000,
  ).withValues(alpha: 0.05);

  // Glass Border Gradients (Simulate Reflection)
  final Color glassBorderLightStart = const Color(
    0xFFFFFFFF,
  ).withValues(alpha: 0.5);
  final Color glassBorderLightEnd = const Color(
    0xFFFFFFFF,
  ).withValues(alpha: 0.1);

  final Color glassBorderDarkStart = const Color(
    0xFFFFFFFF,
  ).withValues(alpha: 0.2);
  final Color glassBorderDarkEnd = const Color(
    0xFFFFFFFF,
  ).withValues(alpha: 0.05);
